function f = s2let_transform_axisym_analysis_adjoint_mw(f_wav, f_scal, varargin)

% s2let_transform_axisym_synthesis_mw
% Compute axisymmetric wavelet transform adjoint, output in pixel space.
%
% Default usage :
%
%   f = s2let_transform_axisym_analysis_adjoint_mw(f_wav, f_scal, <options>)
%
...
f_vec = s2let_transform_axisym_analysis_adjoint_mw_mex(f_wav_vec, f_scal_vec, args.B, args.L, args.J_min, args.Reality, args.Upsample);
