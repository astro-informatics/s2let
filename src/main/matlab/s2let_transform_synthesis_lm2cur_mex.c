...
/**
 * MATLAB interface: s2let_transform_synthesis_lm2cur_mex.
 ...
 * Usage:
 *   flm = ...
 *        s2let_transform_synthesis_lm2cur_mex(f_cur, f_scal, B, L, J_min, N, spin, reality, upsample,
                  ...
                  int nrhs, const mxArray *prhs[])
{
  ...
  if(nrhs!=12) {
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:nrhs",
          "Require twelve inputs.");
  }
  if(nlhs!=1) {
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidOutput:nlhs",
          "Require two outputs.");
  }
  ...
  if( !mxIsLogicalScalar(prhs[iin]) )
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:reality",
  ...
  iin = 8;
  if( !mxIsLogicalScalar(prhs[iin]) )
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:upsample",
  ...
  iin = 9;
  if( !mxIsLogicalScalar(prhs[iin]) )
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:spinlowered",
  ...
  if( !mxIsDouble(prhs[iin]) ||
    ...
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:spinloweredfrom",
  ...
  if( !mxIsDouble(prhs[iin]) ||
      mxIsComplex(prhs[iin]) ||
      mxGetNumberOfElements(prhs[iin])!=1 ) {
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:curveletParameter",
  ...
  if( !mxIsDouble(prhs[iin]) ||
      mxIsComplex(prhs[iin]) ||
      mxGetNumberOfElements(prhs[iin])!=1 ) {
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:LbandLimit",
          "Harmonic band-limit L must be integer.");
  }
  L = (int)mxGetScalar(prhs[iin]);

  if (mxGetScalar(prhs[iin]) > (double)L || L <= 0)
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:bandLimitNonInt",
  ...
  if( !mxIsDouble(prhs[iin]) ||
      mxIsComplex(prhs[iin]) ||
      mxGetNumberOfElements(prhs[iin])!=1 ) {
    mexErrMsgIdAndTxt("s2let_transform_synthesis_lm2cur_mex:InvalidInput:Jmin",
  ...
  if(reality){
      s2let_synthesis_cur2lm_real(flm, f_cur_r, f_scal_r, &parameters);
  }else{
