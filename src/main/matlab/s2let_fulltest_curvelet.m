...
[f_cur_lmn, f_scal_lm]= s2let_transform_curvelet_analysis_lm2lmn(flm_gen_cur,  ...
                                                                 'B', B, 'L', L, 'J_min', J_min,...
...
flm_rec_spin_lmn2lm_custom = s2let_transform_curvelet_synthesis_lmn2lm(f_cur_lmn, f_scal_lm, ...
                                                                      'B', B, 'L', L, 'J_min', J_min,...
                                                                      'Spin', Spin,  'Reality', false, 'Upsample', false,...
                                                                      'SpinLowered', false,  'SpinLoweredFrom', 0, ...
                                                                      'Sampling', 'MW');
...
%[f_cur, f_scal] = s2let_transform_curvelet_analysis_lm2cur(flm_gen_cur, 'N', N, 'Upsample', true);
%flm_rec_lm2cur = s2let_transform_curvelet_synthesis_cur2lm(f_cur, f_scal, 'N', N, 'Upsample', true);
