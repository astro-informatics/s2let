function f = s2let_transform_synthesis_cur_mw(f_cur, f_scal, varargin)

% s2let_transform_synthesis_cur_mw
% Compute spin directional curvelet transform, output in pixel space.
%
% Default usage :
%
%   f = s2let_transform_synthesis_cur_mw(f_cur, f_scal, <options>)
%
...
f_vec = s2let_transform_synthesis_cur_mw_mex(f_cur_vec, f_scal_vec, args.B, args.L, args.J_min, ...
