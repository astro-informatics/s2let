 ...
 */
double f_s2dw(double k, double B) //DOUBLE
{
  double t = (k - (1.0 / B)) * (2.0 * B / (B-1.0)) - 1.0; //DOUBLE
 ...
 */
double s2let_math_kappa0_quadtrap_s2dw(double a, double b, int n, double B) //DOUBLE
{
  double sum = 0;
  double f1, f2;
  int i;
